    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
      {Array(30).map((_, index) => (
        <Card key={index} className={`bg-[#000000]`}>
          <CardHeader className="h-4 w-16 animate-pulse rounded-md bg-primary/10">
            <CardTitle></CardTitle>
          </CardHeader>
          <CardContent className="animate-pulse rounded-md bg-primary/10">
            <div className="mb-4 h-48 w-full rounded object-cover"></div>
          ...
          <CardFooter className="h-4 w-12 animate-pulse rounded-md bg-primary/10">
