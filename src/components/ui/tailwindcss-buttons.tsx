export default function TailwindcssButton() {
  return (
    <button className="relative inline-block cursor-pointer rounded-md border p-px text-xs font-semibold leading-6 text-white no-underline shadow-2xl">
      ...
      <span className="absolute -bottom-0 left-4.5 h-px w-[calc(100%-2.25rem)] bg-linear-to-r from-emerald-400/0 via-[#ff0000e6] to-emerald-400/0 transition-opacity duration-500 group-hover:opacity-40" />
    </button>
  );
}
