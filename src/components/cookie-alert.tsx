...
import AnimatedBar from "./animation-bar";
...
const CookieAlert = ({
  ...
  return (
    ...
    // initial={"hidden"}
    // animate={isAccepted ? "hidden" : "visible"}
    // variants={{
      ...
      <AnimatePresence initial={true}>
        {!isAccepted ? (
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Alert className="fixed top-[calc(100vh-13rem)] left-8 z-2 flex w-[480px] flex-col gap-4">
